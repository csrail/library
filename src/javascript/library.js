...
class Library {
    ...
    #removeBook() {
        ...
        const bookObject = this.#library.find(
            (obj) => obj.bookCount === bookIndex,
        );
        if (bookObject === void 0) {
            return;
        }
        const bookArrayIndex = this.#library.findIndex(
            (obj) => obj === bookObject,
        );
        const bookDisplay = document.querySelector(
    ...
    #toggleBookReadState(button) {
        button.addEventListener("click", () => {
            ...
            let bookObject = this.#library.find(
                (obj) => obj.bookCount === bookIndex,
            );
